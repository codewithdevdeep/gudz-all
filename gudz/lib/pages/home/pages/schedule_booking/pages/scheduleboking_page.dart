...
class SchedulebokingdeatailPage extends StatelessWidget {
  @override
      ...
      body: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            SizedBox(height: 10),
            _buildInfoRow(Icons.account_balance_wallet, 'Payment Method: Gutz Wallet', true, onTap: () {
              Get.to(() => PaymentsPage());
            }),
            SizedBox(height: 20),
            Text(
  ...
  Widget _buildInfoRow(IconData icon, String text, bool hasArrow, {VoidCallback? onTap}) {
    return InkWell(
      onTap: onTap,
      child: Container(

...
class OldBookingDetailsPage extends StatelessWidget {
  @override
  ...
  return Padding(
    ...
    child: Row(
      children: [
        Expanded(
          child: _buildActionButton('Share Details', Icons.send, kPrimaryColor, Colors.white),
        ),
        SizedBox(width: 16),
        Expanded(
          child: _buildActionButton('Need Help?', Icons.help_outline, Colors.grey[200]!, Colors.black),
        ),
      ],
    ),
  );
